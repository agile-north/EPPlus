...
namespace OfficeOpenXml.Drawing
{
    ...
    public sealed class ExcelPicture : ExcelDrawing
    {
            ...
            base(drawings, node, "xdr:pic/xdr:nvPicPr/xdr:cNvPr/@name")
        {
            ...
            _image = SixLabors.ImageSharp.Image.Load(imagestream);
        ...
        private string SavePicture(SixLabors.ImageSharp.Image image)
        {
#if (Core)
        ...
        private void SetPosDefaults(AnyBitmap image)
        {
            ...
            SetPixelWidth(image.Width, (float)(image?.HorizontalResolution ?? 72));
            SetPixelHeight(image.Height, (float)(image?.VerticalResolution ?? 72));
        }
        ...
        public override void SetSize(int Percent)
        {
            ...
            else
            {
                ...
                SetPixelWidth(_width, (float)(Image?.HorizontalResolution ?? 72));
                SetPixelHeight(_height, (float)(Image?.VerticalResolution ?? 72));
            }
        }
