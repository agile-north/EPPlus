...
namespace OfficeOpenXml
{
    ...
    public class ExcelHeaderFooterText
    {
        ...
        public ExcelVmlDrawingPicture InsertPicture(AnyBitmap Picture, PictureAlignment Alignment)
        {
        ...
        public ExcelVmlDrawingPicture InsertPicture(FileInfo PictureFile, PictureAlignment Alignment)
        {
            ...
            try
            {
                ...
                Picture = AnyBitmap.FromFile(PictureFile.FullName);
            }
            catch (Exception ex)
            {
        ...
        private ExcelVmlDrawingPicture AddImage(AnyBitmap Picture, string id, ExcelPackage.ImageInfo ii)
        {
            double width = Picture.Width * 72 / Picture.HorizontalResolution.Value,      //Pixel --> Points
                   height = Picture.Height * 72 / Picture.VerticalResolution.Value;      //Pixel --> Points
            //Add VML-drawing
    ...
    #endregion class ExcelHeaderFooterText
    ...
    public sealed class ExcelHeaderFooter : XmlHelper
    {
        ...
        #endregion ExcelHeaderFooter Private Properties
        ...
        #endregion ExcelHeaderFooter Constructor
        ...
        #endregion ExcelHeaderFooter Public Properties
        ...
        #endregion Save  //  ExcelHeaderFooter
    }

    #endregion ExcelHeaderFooter
}